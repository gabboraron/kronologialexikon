...
function html_saver(s) {
  ...
  body += '<div id="description"> Kattints/koppints a megfelelő sorrendben a képekre/eseményekre </div>';
  ...
  body += '<a id="end_test" class="large success button" > Kész! </a> <div id="result"></div>';
  body += '    <script src="js/test_randomizer_and_test_corrector.js"></script></body></html>';
